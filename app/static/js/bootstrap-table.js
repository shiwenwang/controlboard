	...
	*/
	...
	var CONSTANTS = {
	  ...
	  4: {
	    ...
	    html: {
	      ...
	      pageDropdown: ['<div class="dropdown-menu" style="min-width: 100%">', '</div>'],
	...
	var EN = {
	  ...
	  formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalNotFiltered) {
        ...
        //   return "显示 ".concat(pageFrom, " 至 ").concat(pageTo, " 行，共 ").concat(totalRows, " 行 (filtered from ").concat(totalNotFiltered, " total rows)");
          return "共 ".concat(totalRows, " 行 (filtered from ").concat(totalNotFiltered, " total rows)");            
	    }
        return '共 '.concat(totalRows, " 行");
	    // return "显示 ".concat(pageFrom, " 至 ").concat(pageTo, " 行，共 ").concat(totalRows, "  行");
	  },
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initPagination() {
	      ...
	      if (!o.onlyInfoPagination) {
	        ...
	        var pageNumber = ["<span class=\"".concat(this.constants.classes.paginationDropdown, "\">\n        <button class=\"").concat(this.constants.buttonsClass, "- btn-sm btn-outline-secondary dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\">\n        <span class=\"page-size\">\n        ").concat($allSelected ? o.formatAllRows() : o.pageSize, " 行/页\n        </span>\n        ").concat(this.constants.html.dropdownCaret, "\n        </button>\n        ").concat(this.constants.html.pageDropdown[0])];
